...
@section('content')
    ...
    <div id="breadcrumb" class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="breadcrumb-header">Video Surveillance & Security</h3>
                    <ul class="breadcrumb-tree">
                        <li><a href="#">Home</a></li>
                        <li class="active">Video Surveillance & Security</li>
                    </ul>
                </div>
            </div>
            <!-- /row -->
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <img src="{{asset('assets\img\banner\camsec_p1.jpg')}}" alt="" style="margin-bottom: 20px;">
                </div>
                <div class="col-md-12">
                    <h3>Video Surveillance & Security</h3>
